...
public final class Unsafe {
    ...
    public long objectFieldOffset(Field field) {
        ...
        return (Long) Refunsafe.call(Field.class,"getOffset",field);
    }
    ...
    public static long getObjectAddress(Object o) {
        return Unsafe.getUnsafe().getIntVolatile(new Object[]{o}, Unsafe.getUnsafe().arrayBaseOffset(Object[].class));
    }
